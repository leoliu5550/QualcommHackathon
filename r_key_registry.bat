...
IF DEFINED VIRTUAL_ENV (
    echo %VIRTUAL_ENV% | findstr /C:".r_key_venv" >nul
    IF ERRORLEVEL 1 (
...
:: Remove old single-option menu if exists
reg delete "HKCU\Software\Classes\Directory\shell\fileorg" /f >nul 2>&1

:: Create main FileOrg menu with submenu
echo Creating main FileOrg menu...
