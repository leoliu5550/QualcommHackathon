...
class TestParseResult:
    ...
    def test_parse_result_to_dict(self):
        ...
        result = ParseResult(success=True, content="內容", file_type="txt")
    ...
    def test_parse_result_partial_creation(self):
        ...
        result = ParseResult(success=True, content="test content")
    ...
    def test_parse_result_string_representation(self):
        """測試 ParseResult 字串表示"""
        result = ParseResult(success=True, content="test", file_type="txt")
...
class TestBaseParser:
    ...
    def test_base_parser_custom_char_limit(self):
        ...
        for limit in custom_limits:
            parser = ConcreteParser(char_limit=limit)
...
class TestBaseParserExtended:
    ...
    def test_base_parser_subclass_implementation(self):
        ...
        class TestParser(BaseParser):
            def parse(self, file_path):
                return ParseResult(success=True, content=f"Parsed {file_path}", file_type="test")
    ...
    def test_base_parser_method_override(self):
        ...
        class TestParser(BaseParser):
            ...
            def parse(self, file_path):
                return ParseResult(
                    success=True, content=f"Parsed with {self.extra_param}", file_type="test"
                )
        ...
        class ErrorParser(BaseParser):
            def parse(self, file_path):
                if file_path == "/error/file.txt":
                    return ParseResult(
                        success=False, error="Simulated parsing error", file_path=file_path
                    )
...
class TestParseResultAdvanced:
    ...
    def test_parse_result_equality(self):
        ...
        result1 = ParseResult(success=True, content="test", file_type="txt")

        result2 = ParseResult(success=True, content="test", file_type="txt")

        result3 = ParseResult(success=True, content="different", file_type="txt")
    ...
    def test_parse_result_serialization(self):
        ...
        result = ParseResult(
            success=True, content="測試內容", file_type="txt", original_length=10, truncated=False
        )
    ...
    def test_parse_result_unicode_content(self):
        ...
        result = ParseResult(success=True, content=unicode_content, file_type="txt")
    ...
    def test_parse_result_large_content(self):
        ...
        result = ParseResult(
            success=True, content=large_content, file_type="txt", original_length=100000
        )
